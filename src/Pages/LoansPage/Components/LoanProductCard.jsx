  ...
  return (
    <div className="w-full font-sans py-8 border-b border-gray-200 last:border-b-0">
      <div className="flex flex-col lg:flex-row lg:items-start lg:gap-12">
        {/* Левая часть: Баннер */}
        <div
          className={`w-full lg:w-[450px] shrink-0 h-56 sm:h-72 lg:h-[320px] rounded-3xl overflow-hidden mb-6 lg:mb-0 flex items-center justify-center ${product.imageBgColor}`}
        >
          <img
            src={product.image}
            alt={product.title}
