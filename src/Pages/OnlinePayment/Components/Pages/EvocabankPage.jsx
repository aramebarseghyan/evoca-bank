...
const EvocabankPage = () => {
  // Массив с данными для внутренних карточек с реальными ссылками на изображения
  const services = [
    {
      title: "Վարկի մարում",
  ...
  return (
    <div className="w-full min-h-screen bg-[#f4f5f7] pt-8 pb-12 px-4 sm:px-6 lg:px-8">
