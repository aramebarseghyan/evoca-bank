  ...
  const accordionsData = [
    {
      ...
      content:
        "Հաշիվները բացվում են օպերատիվ կերպով՝ հեռավար եղանակով, առանց բանկ այցելելու անհրաժեշտության։ Անհրաժեշտ է միայն անցնել առցանց նույնականացում և տրամադրել պահանջվող փաստաթղթերի էլեկտրոնային տարբերակները։",
    },
    {
      title: "Ֆիզիկական անձանց հաշվի բացման անհրաժեշտ փաստաթղթեր",
      content:
        "1. Անձնագիր կամ նույնականացման քարտ:\n2. Եկամուտների կամ գործունեობის հիմնավորման փաստաթղթեր (անհրաժեշտության դեպքում):\n3. Լրացված հայտ-դիմում:",
    },
    {
      title: "Իրավաբանական անձանց փաստաթղթերի ցանկ",
      content:
        "1. Պետական գրանցման վկայական և կանոնադրություն:\n2. Տնօրենի և իրական շահառուների անձնագրային տվյալներ:\n3. Լիազորագրեր (առկայության դեպքում):",
    },
    {
      title: "Սակագներ",
      content:
        "Հեռավար սպասարկման և հաշիվների բացման սակագներին կարող եք ծանոթանալ բանկի կողմից սահմանված ընդհանուր պայմանների և սակագների բաժնում։",
    },
    {
      title: "Հաշվի բացման փուլեր",
      content:
        "Քայլ 1: Ուղարկեք փաստաթղթերը օնլայն։\nՔայլ 2: Անցեք տեսազանգով նույնականացում։\nՔայլ 3: Ստացեք հաշվի տվյալները և սկսեք օգտվել ծառայություններից։",
    },
  ];
