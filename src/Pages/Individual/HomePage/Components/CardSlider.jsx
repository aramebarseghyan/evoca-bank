...
const CardSlider = () => {
  ...
  if (cards.length === 0) {
    return (
      <div className="w-full bg-[#F4F7FF] min-h-[300px] flex justify-center items-center font-sans">
  ...
  return (
    <div className="w-full bg-[#F4F7FF] flex flex-col pt-8 pb-12 xl:pb-4 px-5 font-sans min-h-[calc(100vh-200px)] xl:min-h-0 relative">
      <style>{`
