...
const AddressesCard = () => {
  ...
  return (
    ...
    >
      {/* 
        Inline styles for a fast, smooth animation.
        - Animation duration reduced to 1.2s for faster response.
        - The shadow-pulse scale is increased so the shadow grows.
      */}
      <style>{`
        @keyframes pin-float {
      ...
      <div className="relative flex justify-start sm:justify-center lg:justify-start items-center py-2 w-full">
        <div className="relative w-[240px] sm:w-[270px] lg:w-[260px] xl:w-[300px] 2xl:w-[340px]">
          ...
          {/* 
            Purple shadow beneath the pin.
            It shrinks slightly on smartphones (group-hover:scale-75), 
            on xl screens and above it uses the CSS animation "shadow-pulse" 
            and becomes noticeably larger.
          */}
