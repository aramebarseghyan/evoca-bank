  ...
  return (
    <div className="w-full bg-white pb-20">
      <div className="mx-auto px-4 sm:px-6 md:px-5 lg:px-7 xl:px-10 2xl:px-12 md:max-w-[770px] lg:max-w-[1024px] xl:max-w-[1280px] 2xl:max-w-[1536px] pt-6 lg:pt-10">
        ...
        {/* Обертка для сдвига контента на 100px вправо для 2xl */}
        <div className="2xl:ml-[100px]">
          
          {/* Заголовок страницы */}
          <h1 className="text-2xl md:text-[32px] font-bold text-[#1C1C1C] mb-8">
          ...
          <div className="text-[#1C1C1C] space-y-6 text-[15px] leading-[1.6]">
            ...
            <h2 className="font-bold text-[18px] mt-8">Ինչ է վարկային պատմությունը</h2>
            <p>
            ...
            <p>Վարկային բյուրոյի ծառայությունների շնորհիվ յուրաքանչյուր իրավաբանական կամ ֆիզիկական անձ հնարավորություն է ստանում՝</p>
            ...
            <h2 className="font-bold text-[18px] mt-8">Ինչ է վարկային զեկույցը</h2>
            <p>
            ...
            <h2 className="font-bold text-[18px] mt-8">Որքան ժամանակ է պահպանվում վարկային պատմությունը</h2>
            <p>
            ...
            <h2 className="font-bold text-[18px] mt-8">Ինչպես բարելավել վարկային պատմությունը</h2>
            <p>
            ...
            <h2 className="font-bold text-[18px] mt-8">Ուր դիմել եթե վարկային պատմությունը սխալ է</h2>
            <p>
            ...
            <h2 className="font-bold text-[18px] mt-8">Վարկի տրամադրման վերաբերյալ որոշման կայացման չափանիշները</h2>
            <p className="font-bold mt-4">Դրական որոշման կայացման չափանիշները`</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p className="font-bold mt-4">Բացասական որոշման կայացման չափանիշները`</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>
              Վարկային պատմության և ՖԱՅԿՈ սքորի վերաբերյալ առավել մանրամասն տեղեկատվություն կարելի է ստանալ այցելելով՝{" "}
              <a href="https://www.abcfinance.am" target="_blank" rel="noopener noreferrer" className="text-[#5800EB] hover:underline">
                https://www.abcfinance.am
              </a>
              , Հաճախ տրվող հարցեր -{" "}
              <a href="https://acra.am" target="_blank" rel="noopener noreferrer" className="text-[#5800EB] hover:underline">
                ԱՔՌԱ (acra.am)
              </a>{" "}
              և{" "}
              <a href="http://www.acra.am" target="_blank" rel="noopener noreferrer" className="text-[#5800EB] hover:underline">
                www.acra.am
              </a>{" "}
              կայքեր։
            </p>
          ...
          <div className="mt-16 border-t border-gray-100 pt-10">
            <h2 className="text-[22px] font-bold text-[#1C1C1C] mb-6">Փաստաթղթեր</h2>
            ...
            >
              ...
              <div className="shrink-0">
                <svg width="28" height="32" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 2H5.00001C3.89544 2 3.00001 2.89543 3.00001 4V24C3.00001 25.1046 3.89544 26 5.00001 26H19C20.1046 26 21 25.1046 21 24V8L15 2Z" stroke="#8B3DFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M15 2V8H21" stroke="#8B3DFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <circle cx="12" cy="17" r="4" stroke="#8B3DFF" strokeWidth="2"/>
                  <path d="M12 15V19M12 19L10 17M12 19L14 17" stroke="#8B3DFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
